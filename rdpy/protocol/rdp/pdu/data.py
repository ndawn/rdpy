...
"""
from rdpy.core.type import CompositeType, CallableValue, Bytes, UInt8, UInt16Le, UInt32Le, sizeof, ArrayType, FactoryType
...
class PDU(CompositeType):
    ...
    def __init__(self, userId = 0, pduMessage = None):
        ...
        def PDUMessageFactory():
            ...
            #read entire packet
            return Bytes(readLen = CallableValue(self.shareControlHeader.totalLength.value - sizeof(self.shareControlHeader)))
...
class DemandActivePDU(CompositeType):
    ...
    def __init__(self, readLen = None):
        ...
        self.sourceDescriptor = Bytes("rdpy", readLen = self.lengthSourceDescriptor)
...
class DataPDU(CompositeType):
    ...
    def __init__(self, pduData = None, shareId = 0, readLen = None):
        ...
        def PDUDataFactory():
            ...
            return Bytes(readLen = CallableValue(readLen.value - sizeof(self.shareDataHeader)))
...
class UpdateDataPDU(CompositeType):
    ...
    def __init__(self, updateData = None, readLen = None):
        ...
        def UpdateDataFactory():
            ...
            return Bytes(readLen = CallableValue(readLen.value - 2))
...
class FastPathUpdatePDU(CompositeType):
    ...
    def __init__(self, updateData = None):
        ...
        def UpdateDataFactory():
            ...
            return Bytes(readLen = self.size)
...
class BitmapData(CompositeType):
    ...
    def __init__(self, destLeft = 0, destTop = 0, destRight = 0, destBottom = 0, width = 0, height = 0, bitsPerPixel = 0, bitmapDataStream = ""):
        ...
        self.bitmapDataStream = Bytes(bitmapDataStream, readLen = CallableValue(lambda:(self.bitmapLength.value if (not self.flags.value & BitmapFlag.BITMAP_COMPRESSION or self.flags.value & BitmapFlag.NO_BITMAP_COMPRESSION_HDR) else self.bitmapComprHdr.cbCompMainBodySize.value)))
