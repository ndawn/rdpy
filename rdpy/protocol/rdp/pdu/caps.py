...
class Capability(CompositeType):
    ...
    def __init__(self, capability = None):
        ...
        def CapabilityFactory():
            ...
            #read entire packet
            return Bytes(readLen = self.lengthCapability - 4)
...
class OrderCapability(CompositeType):
    ...
    def __init__(self, readLen = None):
        CompositeType.__init__(self, readLen = readLen)
        self.terminalDescriptor = Bytes(b"\x00" * 16, readLen = CallableValue(16))
...
class InputCapability(CompositeType):
    ...
    def __init__(self, readLen = None):
        ...
        self.imeFileName = Bytes(b"\x00" * 64, readLen = CallableValue(64))
